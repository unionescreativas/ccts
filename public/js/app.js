...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    consultarDocumentos: function consultarDocumentos() {
      var _this = this;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.prev = 0;
                _context.next = 3;
                return axios__WEBPACK_IMPORTED_MODULE_1___default.a.get("/documentos");

              case 3:
                res = _context.sent;
                documentos = res.data.data.map(function (data) {
                  return _objectSpread(_objectSpread({}, data), {}, {
                    name: data.nombre_carga,
                    lastModified: data.updated_at,
                    size: data.tamano,
                    type: data.aplicacion,
                    url: "".concat(process.env.API_URL, "/storage").concat(data.url_descarga)
                  });
                });
                console.log(res);
                _this.fileRecords = documentos;
                _context.next = 11;
                break;
    ...
    uploadFiles: function uploadFiles() {
      ...
      var mensajeGuardar = "El documento se ha subido con éxito!";
      var mensajeError = "No se pudo subir el documento, consulte con el administrador!";
      this.fileRecordsForUpload.forEach(function (_ref, index) {
        var file = _ref.file;
        return formData.append("file[".concat(index, "]"), file, file.newName);
      }); // Using the default uploader. You may use another uploader instead.

      console.log(formData);

      try {
        var res = axios__WEBPACK_IMPORTED_MODULE_1___default.a.post("/documentos", formData, {
          header: {
        ...
        this.$swal.fire({
          html: "<h4>".concat(mensajeGuardar, "</h4>"),
          icon: "success",
        ...
        console.log(err);
        var status = 500; // ERROR DEL CLIENTE

        if (status <= 499) {// ERROR DEL SERVIDOR
        } else {
          this.$swal.fire({
            html: "<h4>".concat(mensajeError, "</h4>"),
            icon: "error",
            allowOutsideClick: false,
            allowEscapeKey: false
          });
...
/*!*********************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader??ref--6-1!./node_modules/postcss-loader/src??ref--6-2!./node_modules/vue-file-agent/dist/vue-file-agent.css ***!
  \*********************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var content = __webpack_require__(/*! !../../css-loader??ref--6-1!../../postcss-loader/src??ref--6-2!./vue-file-agent.css */ "./node_modules/css-loader/index.js?!./node_modules/postcss-loader/src/index.js?!./node_modules/vue-file-agent/dist/vue-file-agent.css");
...
vue__WEBPACK_IMPORTED_MODULE_0___default.a.use(vue_file_agent__WEBPACK_IMPORTED_MODULE_1___default.a); // ---------------------------->VueFileAgent
// ---------------------------->Axios
...
vue__WEBPACK_IMPORTED_MODULE_0___default.a.use(vue_sweetalert2__WEBPACK_IMPORTED_MODULE_4__["default"]); // Vue.use(VueSweetalert2);
// ---------------------------->VueSweetalert2
...
__webpack_require__(/*! C:\laragon\www\ccts\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\laragon\www\ccts\resources\sass\app.scss */"./resources/sass/app.scss");
